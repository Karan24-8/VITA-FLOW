...
export default function DayPlanner() {
  ...
  const [logged, setLogged] = useState(() => {
    try {
      ...
      return (saved && saved.date === dateStr) ? normalizeLogged(saved.logged) : normalizeLogged(null);
    } catch { return normalizeLogged(null); }
  });
      ...
      <div className="page-body">
        ...
        <div style={{ marginTop: 24 }}>
          ...
          {workoutLoading ? (
            ...
            <div style={{ textAlign: 'center', padding: 40, color: 'var(--text-muted)' }}>No exercises generated for today.</div>
          ) : (
            <div className="meals-row">
              {workouts.map((w, i) => (
